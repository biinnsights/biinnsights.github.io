...
<div class="container">
			<div class="p-b-10">
				<h3 class="ltext-103 cl5" style="margin-top:50px;">
					Category
				</h3>
			</div>
...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<button class="excerpt hidden-sm hidden-md" data-toggle="dropdown">
						<?php echo htmlentities($row['categoryName']);?></button>
