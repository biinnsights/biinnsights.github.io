	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product-detail.php?pid=<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['productName'];
...
?>
					...
					<td class="cart-product-quantity">
									...
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<input type="number" class="mtext-104 cl3 txt-center num-product" value="<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>" name="quantity[<?php echo $row['id']; ?>]">
