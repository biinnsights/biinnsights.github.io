...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("product_quantity" => 1, "price" => $row_p['product_price']);
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="#currentorder" role="tab">Current order</a>
						</li>

						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#previousorder" role="tab">Previous order</a>
						</li>
					...
					<div class="tab-content p-t-43">
						<!-- - -->
						<div class="tab-pane fade show active" id="currentorder" role="tabpanel">
			...
			<div class="row">
				<div class="col-lg-15 col-xl-12 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						...
						<!-- - -->
	<div class="tab-pane fade" id="previousorder" role="tabpanel">
		<div class="container">
			<div class="row">
				<div class="col-lg-15 col-xl-12 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
