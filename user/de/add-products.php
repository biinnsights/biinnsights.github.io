...
if(isset($_POST['submit']))
{
  ...
  if($_FILES['product_image1'])
  {
    if(move_uploaded_file($_FILES['product_image1']['tmp_name'], 'uploads/'.$_FILES['product_image1'][name]))
    {
      $data['product_image1']= $_FILES['product_image1']['name'];
    }
  }
  ...
  <div class="content-wrapper">
    ...
    <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Product Example</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
