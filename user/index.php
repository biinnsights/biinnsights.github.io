				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<?php echo "../admin/".$row["product_image"];?>" alt="IMG">
						</div>
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?request_id=<?php echo $doc['id'];?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									<?php echo $doc['product_name'];?>
								</a>

								<span class="stext-105 cl3">
									<?php echo $doc['product_price'];?>
								</span>
							</div>
