...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="feedback deleted !!";
		  }
...
?>									
										<tr>
											...
											<a href="customer-feedback.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
