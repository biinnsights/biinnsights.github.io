...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="customer-feedback.php"><i class="menu-icon icon-table"></i>Manage Feedback </a></li>
                                <li><a href="/finalcome/admin/inventory/"><i class="menu-icon icon-table"></i> Inventory </a></li>
								 <li><a href="catalog.php"><i class="menu-icon icon-table"></i> Catalog </a></li>
								  <li><a href="seller.php"><i class="menu-icon icon-table"></i> Seller </a></li>

								    <li><a href="agents.php"><i class="menu-icon icon-table"></i>Delivery dealers </a></li>
								<ul class="widget widget-menu unstyled">
							<li>
