...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="agents deleted !!";
		  }
...
<?php $query=mysqli_query($con,"select * from delivery");
$cnt=1;
...
?>									
										<tr>
											...
											<td><?php echo htmlentities($row['company name']);?></td>
											<td><?php echo htmlentities($row['address']);?></td>
											<td> <?php echo htmlentities($row['phone']);?></td>
											<td><?php echo htmlentities($row['products']);?></td>
											<td><?php echo htmlentities($row['expected delivery date']);?>
											<td><?php echo htmlentities($row['confirmed date']);?>
											</td>
											<td>
